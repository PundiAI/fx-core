...
func TestResetExportGenesisValidator(t *testing.T) {
	...
	encodingConfig.Marshaler.MustUnmarshalJSON(appState[stakingtypes.ModuleName], stakingGenesisState)
	...
	appState[stakingtypes.ModuleName] = encodingConfig.Marshaler.MustMarshalJSON(stakingGenesisState)
	...
	encodingConfig.Marshaler.MustUnmarshalJSON(appState[slashingtypes.ModuleName], slashingGenesisState)
	...
	appState[slashingtypes.ModuleName] = encodingConfig.Marshaler.MustMarshalJSON(slashingGenesisState)
