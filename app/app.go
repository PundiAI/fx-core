...
func New(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool, skipUpgradeHeights map[int64]bool,
	...
	rootmulti.AddIgnoreCommitKey(types2.CrossChainSupportBscBlock(), bsctypes.StoreKey)
	rootmulti.AddIgnoreCommitKey(types2.CrossChainSupportPolygonBlock(), polygontypes.StoreKey)
	rootmulti.AddIgnoreCommitKey(types2.CrossChainSupportTronBlock(), trontypes.StoreKey)
