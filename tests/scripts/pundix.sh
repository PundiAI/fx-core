...
LOCAL_STAKING_BOND_DENOM="$($DAEMON query fx-ibc-transfer denom-convert "transfer/$IBC_CHAINNEL/eth$PUNDIX_ADDRESS" --home "$NODE_HOME" | jq -r .IBCDenom)"
