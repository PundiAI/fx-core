...
// ensureExistsWithHeight ensure account exist at height
func (b *Backend) ensureExistsWithHeight(accAddr common.Address, height int64) error {
	queryClient := authtypes.NewQueryClient(b.clientCtx)
...
func (b *Backend) processBlock(
	...
	targetOneFeeHistory *types.OneFeeHistory) error {
