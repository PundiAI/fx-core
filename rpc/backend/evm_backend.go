...
func (b *Backend) SendTransaction(args evmtypes.TransactionArgs) (common.Hash, error) {
	...
	tx, err := msg.BuildTx(b.clientCtx.TxConfig.NewTxBuilder(), fxtypes.DefaultDenom)
	if err != nil {
...
func (b *Backend) GetTransactionCount(address common.Address, blockNum types.BlockNumber) (*hexutil.Uint64, error) {
	...
	currentHeight, _ := b.BlockNumber()
	if int64(currentHeight) < blockNum.Int64() {
		return nil, errors.New("unknown block")
	}
	if err := b.ensureExistsWithHeight(address, blockNum.Int64()); err != nil {
...
func (b *Backend) ChainConfig() *params.ChainConfig {
	return evmtypes.DefEthereumConfig(b.chainID)
}
...
func (b *Backend) SuggestGasTipCap(baseFee *big.Int) (*big.Int, error) {
	...
	feeMarketParams, err := b.queryClient.FeeMarket.Params(b.ctx, &feemarkettypes.QueryParamsRequest{})
	if err != nil {
		return nil, err
	}
