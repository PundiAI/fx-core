...
func init() {
	...
	md_GenesisState = File_fx_erc20_v1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_fx_erc20_v1_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fx.erc20.v1.GenesisState.params":
		return x.Params != nil
	case "fx.erc20.v1.GenesisState.token_pairs":
		return len(x.TokenPairs) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.erc20.v1.GenesisState"))
		}
		panic(fmt.Errorf("message fx.erc20.v1.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message fx.erc20.v1.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fx.erc20.v1.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *Params) slowProtoReflect() protoreflect.Message {
	mi := &file_fx_erc20_v1_genesis_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message fx.erc20.v1.Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message fx.erc20.v1.Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fx.erc20.v1.Params", d.FullName()))
	}
	panic("unreachable")
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_fx_erc20_v1_genesis_proto_rawDescGZIP(), []int{0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return file_fx_erc20_v1_genesis_proto_rawDescGZIP(), []int{1}
}
...
var file_fx_erc20_v1_genesis_proto_rawDesc = []byte{
	...
	0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x01, 0x0a, 0x0c, 0x47, 0x65, 0x6e, 0x65,
	...
	0x30, 0x42, 0xa4, 0x01, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x78, 0x2e, 0x65, 0x72, 0x63,
...
var (
	file_fx_erc20_v1_genesis_proto_rawDescOnce sync.Once
	file_fx_erc20_v1_genesis_proto_rawDescData = file_fx_erc20_v1_genesis_proto_rawDesc
)

func file_fx_erc20_v1_genesis_proto_rawDescGZIP() []byte {
	file_fx_erc20_v1_genesis_proto_rawDescOnce.Do(func() {
		file_fx_erc20_v1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_fx_erc20_v1_genesis_proto_rawDescData)
	})
	return file_fx_erc20_v1_genesis_proto_rawDescData
}
...
func file_fx_erc20_v1_genesis_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_fx_erc20_v1_genesis_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Params); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_fx_erc20_v1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_fx_erc20_v1_genesis_proto_goTypes,
		DependencyIndexes: file_fx_erc20_v1_genesis_proto_depIdxs,
		MessageInfos:      file_fx_erc20_v1_genesis_proto_msgTypes,
	}.Build()
	File_fx_erc20_v1_genesis_proto = out.File
	file_fx_erc20_v1_genesis_proto_rawDesc = nil
	file_fx_erc20_v1_genesis_proto_goTypes = nil
	file_fx_erc20_v1_genesis_proto_depIdxs = nil
}
