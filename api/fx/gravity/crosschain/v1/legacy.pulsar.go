...
var (
	...
	fd_BridgeToken_channel_ibc protoreflect.FieldDescriptor
)

func init() {
	file_fx_gravity_crosschain_v1_legacy_proto_init()
	md_BridgeToken = File_fx_gravity_crosschain_v1_legacy_proto.Messages().ByName("BridgeToken")
	fd_BridgeToken_token = md_BridgeToken.Fields().ByName("token")
	fd_BridgeToken_denom = md_BridgeToken.Fields().ByName("denom")
	fd_BridgeToken_channel_ibc = md_BridgeToken.Fields().ByName("channel_ibc")
}
...
func (x *BridgeToken) slowProtoReflect() protoreflect.Message {
	mi := &file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_BridgeToken) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ChannelIbc != "" {
		value := protoreflect.ValueOfString(x.ChannelIbc)
		if !f(fd_BridgeToken_channel_ibc, value) {
			return
		}
	}
}
...
func (x *fastReflection_BridgeToken) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fx.gravity.crosschain.v1.BridgeToken.denom":
		return x.Denom != ""
	case "fx.gravity.crosschain.v1.BridgeToken.channel_ibc":
		return x.ChannelIbc != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_BridgeToken) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "fx.gravity.crosschain.v1.BridgeToken.denom":
		x.Denom = value.Interface().(string)
	case "fx.gravity.crosschain.v1.BridgeToken.channel_ibc":
		x.ChannelIbc = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.BridgeToken"))
		}
...
func (x *fastReflection_BridgeToken) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fx.gravity.crosschain.v1.BridgeToken.channel_ibc":
		panic(fmt.Errorf("field channel_ibc of message fx.gravity.crosschain.v1.BridgeToken is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.BridgeToken"))
		}
...
func (x *fastReflection_BridgeToken) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ChannelIbc) > 0 {
			i -= len(x.ChannelIbc)
			copy(dAtA[i:], x.ChannelIbc)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ChannelIbc)))
			i--
			dAtA[i] = 0x1a
		}
		if len(x.Denom) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ChannelIbc", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ChannelIbc = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
var (
	...
	fd_BatchFees_token_contract protoreflect.FieldDescriptor
	fd_BatchFees_total_fees     protoreflect.FieldDescriptor
	fd_BatchFees_total_txs      protoreflect.FieldDescriptor
	fd_BatchFees_total_amount   protoreflect.FieldDescriptor
)

func init() {
	file_fx_gravity_crosschain_v1_legacy_proto_init()
	md_BatchFees = File_fx_gravity_crosschain_v1_legacy_proto.Messages().ByName("BatchFees")
	fd_BatchFees_token_contract = md_BatchFees.Fields().ByName("token_contract")
	fd_BatchFees_total_fees = md_BatchFees.Fields().ByName("total_fees")
	fd_BatchFees_total_txs = md_BatchFees.Fields().ByName("total_txs")
	fd_BatchFees_total_amount = md_BatchFees.Fields().ByName("total_amount")
}
...
func (x *BatchFees) slowProtoReflect() protoreflect.Message {
	mi := &file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_BatchFees) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.TokenContract != "" {
		...
		if !f(fd_BatchFees_token_contract, value) {
			return
		}
	}
	if x.TotalFees != "" {
	...
	if x.TotalTxs != uint64(0) {
		value := protoreflect.ValueOfUint64(x.TotalTxs)
		if !f(fd_BatchFees_total_txs, value) {
			return
		}
	}
	if x.TotalAmount != "" {
		value := protoreflect.ValueOfString(x.TotalAmount)
		if !f(fd_BatchFees_total_amount, value) {
			return
		}
	}
}
...
func (x *fastReflection_BatchFees) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.BatchFees.token_contract":
		return x.TokenContract != ""
	case "fx.gravity.crosschain.v1.BatchFees.total_fees":
		return x.TotalFees != ""
	case "fx.gravity.crosschain.v1.BatchFees.total_txs":
		return x.TotalTxs != uint64(0)
	case "fx.gravity.crosschain.v1.BatchFees.total_amount":
		return x.TotalAmount != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.BatchFees"))
		}
		panic(fmt.Errorf("message fx.gravity.crosschain.v1.BatchFees does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BatchFees) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message fx.gravity.crosschain.v1.BatchFees does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BatchFees) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.BatchFees.token_contract":
		panic(fmt.Errorf("field token_contract of message fx.gravity.crosschain.v1.BatchFees is not mutable"))
	case "fx.gravity.crosschain.v1.BatchFees.total_fees":
		panic(fmt.Errorf("field total_fees of message fx.gravity.crosschain.v1.BatchFees is not mutable"))
	case "fx.gravity.crosschain.v1.BatchFees.total_txs":
		panic(fmt.Errorf("field total_txs of message fx.gravity.crosschain.v1.BatchFees is not mutable"))
	case "fx.gravity.crosschain.v1.BatchFees.total_amount":
		panic(fmt.Errorf("field total_amount of message fx.gravity.crosschain.v1.BatchFees is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.BatchFees"))
		}
...
func (x *fastReflection_BatchFees) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fx.gravity.crosschain.v1.BatchFees", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_BatchFees) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.TotalTxs != 0 {
			n += 1 + runtime.Sov(uint64(x.TotalTxs))
		}
		l = len(x.TotalAmount)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.TotalTxs != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.TotalTxs))
			i--
			dAtA[i] = 0x18
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalTxs", wireType)
				}
				x.TotalTxs = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.TotalTxs |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
var (
	md_MinBatchFee                protoreflect.MessageDescriptor
	fd_MinBatchFee_token_contract protoreflect.FieldDescriptor
	fd_MinBatchFee_base_fee       protoreflect.FieldDescriptor
)

func init() {
	file_fx_gravity_crosschain_v1_legacy_proto_init()
	md_MinBatchFee = File_fx_gravity_crosschain_v1_legacy_proto.Messages().ByName("MinBatchFee")
	fd_MinBatchFee_token_contract = md_MinBatchFee.Fields().ByName("token_contract")
	fd_MinBatchFee_base_fee = md_MinBatchFee.Fields().ByName("base_fee")
}

var _ protoreflect.Message = (*fastReflection_MinBatchFee)(nil)

type fastReflection_MinBatchFee MinBatchFee

func (x *MinBatchFee) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MinBatchFee)(x)
}

func (x *MinBatchFee) slowProtoReflect() protoreflect.Message {
	mi := &file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_MinBatchFee_messageType fastReflection_MinBatchFee_messageType
var _ protoreflect.MessageType = fastReflection_MinBatchFee_messageType{}

type fastReflection_MinBatchFee_messageType struct{}

func (x fastReflection_MinBatchFee_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MinBatchFee)(nil)
}
func (x fastReflection_MinBatchFee_messageType) New() protoreflect.Message {
	return new(fastReflection_MinBatchFee)
}
func (x fastReflection_MinBatchFee_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MinBatchFee
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MinBatchFee) Descriptor() protoreflect.MessageDescriptor {
	return md_MinBatchFee
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MinBatchFee) Type() protoreflect.MessageType {
	return _fastReflection_MinBatchFee_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MinBatchFee) New() protoreflect.Message {
	return new(fastReflection_MinBatchFee)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MinBatchFee) Interface() protoreflect.ProtoMessage {
	return (*MinBatchFee)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MinBatchFee) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.TokenContract != "" {
		value := protoreflect.ValueOfString(x.TokenContract)
		if !f(fd_MinBatchFee_token_contract, value) {
			return
		}
	}
	if x.BaseFee != "" {
		value := protoreflect.ValueOfString(x.BaseFee)
		if !f(fd_MinBatchFee_base_fee, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MinBatchFee) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.MinBatchFee.token_contract":
		return x.TokenContract != ""
	case "fx.gravity.crosschain.v1.MinBatchFee.base_fee":
		return x.BaseFee != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.MinBatchFee"))
		}
		panic(fmt.Errorf("message fx.gravity.crosschain.v1.MinBatchFee does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MinBatchFee) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.MinBatchFee.token_contract":
		x.TokenContract = ""
	case "fx.gravity.crosschain.v1.MinBatchFee.base_fee":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MinBatchFee) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "fx.gravity.crosschain.v1.MinBatchFee.token_contract":
		value := x.TokenContract
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message fx.gravity.crosschain.v1.MinBatchFee does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MinBatchFee) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.MinBatchFee.token_contract":
		x.TokenContract = value.Interface().(string)
	case "fx.gravity.crosschain.v1.MinBatchFee.base_fee":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MinBatchFee) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.MinBatchFee.token_contract":
		panic(fmt.Errorf("field token_contract of message fx.gravity.crosschain.v1.MinBatchFee is not mutable"))
	case "fx.gravity.crosschain.v1.MinBatchFee.base_fee":
		panic(fmt.Errorf("field base_fee of message fx.gravity.crosschain.v1.MinBatchFee is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.MinBatchFee"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MinBatchFee) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.MinBatchFee.token_contract":
		return protoreflect.ValueOfString("")
	case "fx.gravity.crosschain.v1.MinBatchFee.base_fee":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MinBatchFee) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fx.gravity.crosschain.v1.MinBatchFee", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MinBatchFee) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MinBatchFee) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MinBatchFee) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MinBatchFee) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MinBatchFee)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MinBatchFee: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MinBatchFee: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var _ protoreflect.List = (*_QueryBatchFeeRequest_2_list)(nil)

type _QueryBatchFeeRequest_2_list struct {
	list *[]*MinBatchFee
}

func (x *_QueryBatchFeeRequest_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryBatchFeeRequest_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryBatchFeeRequest_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*MinBatchFee)
	(*x.list)[i] = concreteValue
}

func (x *_QueryBatchFeeRequest_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*MinBatchFee)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryBatchFeeRequest_2_list) AppendMutable() protoreflect.Value {
	v := new(MinBatchFee)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryBatchFeeRequest_2_list) Truncate(n int) {
...
func (x *_QueryBatchFeeRequest_2_list) NewElement() protoreflect.Value {
	v := new(MinBatchFee)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryBatchFeeRequest_2_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryBatchFeeRequest                protoreflect.MessageDescriptor
	fd_QueryBatchFeeRequest_chain_name     protoreflect.FieldDescriptor
	fd_QueryBatchFeeRequest_min_batch_fees protoreflect.FieldDescriptor
)

func init() {
	file_fx_gravity_crosschain_v1_legacy_proto_init()
	md_QueryBatchFeeRequest = File_fx_gravity_crosschain_v1_legacy_proto.Messages().ByName("QueryBatchFeeRequest")
	fd_QueryBatchFeeRequest_chain_name = md_QueryBatchFeeRequest.Fields().ByName("chain_name")
	fd_QueryBatchFeeRequest_min_batch_fees = md_QueryBatchFeeRequest.Fields().ByName("min_batch_fees")
}

var _ protoreflect.Message = (*fastReflection_QueryBatchFeeRequest)(nil)

type fastReflection_QueryBatchFeeRequest QueryBatchFeeRequest

func (x *QueryBatchFeeRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryBatchFeeRequest)(x)
}

func (x *QueryBatchFeeRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryBatchFeeRequest_messageType fastReflection_QueryBatchFeeRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryBatchFeeRequest_messageType{}

type fastReflection_QueryBatchFeeRequest_messageType struct{}

func (x fastReflection_QueryBatchFeeRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryBatchFeeRequest)(nil)
}
func (x fastReflection_QueryBatchFeeRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryBatchFeeRequest)
}
func (x fastReflection_QueryBatchFeeRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryBatchFeeRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryBatchFeeRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryBatchFeeRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryBatchFeeRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryBatchFeeRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryBatchFeeRequest) New() protoreflect.Message {
	return new(fastReflection_QueryBatchFeeRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryBatchFeeRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryBatchFeeRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryBatchFeeRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ChainName != "" {
		value := protoreflect.ValueOfString(x.ChainName)
		if !f(fd_QueryBatchFeeRequest_chain_name, value) {
			return
		}
	}
	if len(x.MinBatchFees) != 0 {
		value := protoreflect.ValueOfList(&_QueryBatchFeeRequest_2_list{list: &x.MinBatchFees})
		if !f(fd_QueryBatchFeeRequest_min_batch_fees, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryBatchFeeRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.chain_name":
		return x.ChainName != ""
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.min_batch_fees":
		return len(x.MinBatchFees) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.QueryBatchFeeRequest"))
		}
		panic(fmt.Errorf("message fx.gravity.crosschain.v1.QueryBatchFeeRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryBatchFeeRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.chain_name":
		x.ChainName = ""
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.min_batch_fees":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryBatchFeeRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.chain_name":
		value := x.ChainName
		return protoreflect.ValueOfString(value)
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.min_batch_fees":
		if len(x.MinBatchFees) == 0 {
			return protoreflect.ValueOfList(&_QueryBatchFeeRequest_2_list{})
		}
		listValue := &_QueryBatchFeeRequest_2_list{list: &x.MinBatchFees}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.QueryBatchFeeRequest"))
		}
		panic(fmt.Errorf("message fx.gravity.crosschain.v1.QueryBatchFeeRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryBatchFeeRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.chain_name":
		x.ChainName = value.Interface().(string)
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.min_batch_fees":
		lv := value.List()
		clv := lv.(*_QueryBatchFeeRequest_2_list)
		x.MinBatchFees = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.QueryBatchFeeRequest"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryBatchFeeRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.min_batch_fees":
		if x.MinBatchFees == nil {
			x.MinBatchFees = []*MinBatchFee{}
		}
		value := &_QueryBatchFeeRequest_2_list{list: &x.MinBatchFees}
		return protoreflect.ValueOfList(value)
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.chain_name":
		panic(fmt.Errorf("field chain_name of message fx.gravity.crosschain.v1.QueryBatchFeeRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.QueryBatchFeeRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryBatchFeeRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.chain_name":
		return protoreflect.ValueOfString("")
	case "fx.gravity.crosschain.v1.QueryBatchFeeRequest.min_batch_fees":
		list := []*MinBatchFee{}
		return protoreflect.ValueOfList(&_QueryBatchFeeRequest_2_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.QueryBatchFeeRequest"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryBatchFeeRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fx.gravity.crosschain.v1.QueryBatchFeeRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryBatchFeeRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryBatchFeeRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryBatchFeeRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryBatchFeeRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryBatchFeeRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.MinBatchFees) > 0 {
			for iNdEx := len(x.MinBatchFees) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.MinBatchFees[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryBatchFeeRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryBatchFeeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MinBatchFees", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.MinBatchFees = append(x.MinBatchFees, &MinBatchFee{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.MinBatchFees[len(x.MinBatchFees)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var _ protoreflect.List = (*_QueryBatchFeeResponse_1_list)(nil)

type _QueryBatchFeeResponse_1_list struct {
	list *[]*BatchFees
}

func (x *_QueryBatchFeeResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryBatchFeeResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryBatchFeeResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*BatchFees)
	(*x.list)[i] = concreteValue
}

func (x *_QueryBatchFeeResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*BatchFees)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryBatchFeeResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(BatchFees)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryBatchFeeResponse_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryBatchFeeResponse_1_list) NewElement() protoreflect.Value {
	v := new(BatchFees)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryBatchFeeResponse_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryBatchFeeResponse            protoreflect.MessageDescriptor
	fd_QueryBatchFeeResponse_batch_fees protoreflect.FieldDescriptor
)

func init() {
	file_fx_gravity_crosschain_v1_legacy_proto_init()
	md_QueryBatchFeeResponse = File_fx_gravity_crosschain_v1_legacy_proto.Messages().ByName("QueryBatchFeeResponse")
	fd_QueryBatchFeeResponse_batch_fees = md_QueryBatchFeeResponse.Fields().ByName("batch_fees")
}

var _ protoreflect.Message = (*fastReflection_QueryBatchFeeResponse)(nil)

type fastReflection_QueryBatchFeeResponse QueryBatchFeeResponse

func (x *QueryBatchFeeResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryBatchFeeResponse)(x)
}

func (x *QueryBatchFeeResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryBatchFeeResponse_messageType fastReflection_QueryBatchFeeResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryBatchFeeResponse_messageType{}

type fastReflection_QueryBatchFeeResponse_messageType struct{}

func (x fastReflection_QueryBatchFeeResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryBatchFeeResponse)(nil)
}
func (x fastReflection_QueryBatchFeeResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryBatchFeeResponse)
}
func (x fastReflection_QueryBatchFeeResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryBatchFeeResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryBatchFeeResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryBatchFeeResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryBatchFeeResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryBatchFeeResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryBatchFeeResponse) New() protoreflect.Message {
	return new(fastReflection_QueryBatchFeeResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryBatchFeeResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryBatchFeeResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryBatchFeeResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.BatchFees) != 0 {
		value := protoreflect.ValueOfList(&_QueryBatchFeeResponse_1_list{list: &x.BatchFees})
		if !f(fd_QueryBatchFeeResponse_batch_fees, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryBatchFeeResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeResponse.batch_fees":
		return len(x.BatchFees) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.QueryBatchFeeResponse"))
		}
		panic(fmt.Errorf("message fx.gravity.crosschain.v1.QueryBatchFeeResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryBatchFeeResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeResponse.batch_fees":
		x.BatchFees = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryBatchFeeResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeResponse.batch_fees":
		if len(x.BatchFees) == 0 {
			return protoreflect.ValueOfList(&_QueryBatchFeeResponse_1_list{})
		}
		listValue := &_QueryBatchFeeResponse_1_list{list: &x.BatchFees}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.QueryBatchFeeResponse"))
		}
		panic(fmt.Errorf("message fx.gravity.crosschain.v1.QueryBatchFeeResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryBatchFeeResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeResponse.batch_fees":
		lv := value.List()
		clv := lv.(*_QueryBatchFeeResponse_1_list)
		x.BatchFees = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.QueryBatchFeeResponse"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryBatchFeeResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeResponse.batch_fees":
		if x.BatchFees == nil {
			x.BatchFees = []*BatchFees{}
		}
		value := &_QueryBatchFeeResponse_1_list{list: &x.BatchFees}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.QueryBatchFeeResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryBatchFeeResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fx.gravity.crosschain.v1.QueryBatchFeeResponse.batch_fees":
		list := []*BatchFees{}
		return protoreflect.ValueOfList(&_QueryBatchFeeResponse_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fx.gravity.crosschain.v1.QueryBatchFeeResponse"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryBatchFeeResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fx.gravity.crosschain.v1.QueryBatchFeeResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryBatchFeeResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryBatchFeeResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryBatchFeeResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryBatchFeeResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryBatchFeeResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.BatchFees) > 0 {
			for iNdEx := len(x.BatchFees) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.BatchFees[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryBatchFeeResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryBatchFeeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field BatchFees", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.BatchFees = append(x.BatchFees, &BatchFees{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.BatchFees[len(x.BatchFees)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
func (*BridgeToken) Descriptor() ([]byte, []int) {
	return file_fx_gravity_crosschain_v1_legacy_proto_rawDescGZIP(), []int{13}
}
...
func (x *BridgeToken) GetChannelIbc() string {
	if x != nil {
		return x.ChannelIbc
	}
	return ""
...
func (*BatchFees) Descriptor() ([]byte, []int) {
	return file_fx_gravity_crosschain_v1_legacy_proto_rawDescGZIP(), []int{14}
}

func (x *BatchFees) GetTokenContract() string {
	if x != nil {
		return x.TokenContract
	}
	return ""
...
func (x *BatchFees) GetTotalTxs() uint64 {
	if x != nil {
		return x.TotalTxs
	}
	return 0
...
func (x *BatchFees) GetTotalAmount() string {
	if x != nil {
		return x.TotalAmount
	}
	return ""
...
func (x *MinBatchFee) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MinBatchFee) ProtoMessage() {}

// Deprecated: Use MinBatchFee.ProtoReflect.Descriptor instead.
func (*MinBatchFee) Descriptor() ([]byte, []int) {
	return file_fx_gravity_crosschain_v1_legacy_proto_rawDescGZIP(), []int{15}
}

func (x *MinBatchFee) GetTokenContract() string {
	if x != nil {
		return x.TokenContract
	}
	return ""
...
func (x *MinBatchFee) GetBaseFee() string {
	if x != nil {
		return x.BaseFee
	}
	return ""
...
type QueryBatchFeeRequest struct {
	...
	ChainName    string         `protobuf:"bytes,1,opt,name=chain_name,json=chainName,proto3" json:"chain_name,omitempty"`
	MinBatchFees []*MinBatchFee `protobuf:"bytes,2,rep,name=min_batch_fees,json=minBatchFees,proto3" json:"min_batch_fees,omitempty"`
}

func (x *QueryBatchFeeRequest) Reset() {
	*x = QueryBatchFeeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryBatchFeeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryBatchFeeRequest) ProtoMessage() {}

// Deprecated: Use QueryBatchFeeRequest.ProtoReflect.Descriptor instead.
func (*QueryBatchFeeRequest) Descriptor() ([]byte, []int) {
	return file_fx_gravity_crosschain_v1_legacy_proto_rawDescGZIP(), []int{16}
}

func (x *QueryBatchFeeRequest) GetChainName() string {
	if x != nil {
		return x.ChainName
	}
	return ""
...
func (x *QueryBatchFeeRequest) GetMinBatchFees() []*MinBatchFee {
	if x != nil {
		return x.MinBatchFees
	}
	return nil
}
...
func (x *QueryBatchFeeResponse) Reset() {
...
func (x *QueryBatchFeeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryBatchFeeResponse) ProtoMessage() {}

// Deprecated: Use QueryBatchFeeResponse.ProtoReflect.Descriptor instead.
func (*QueryBatchFeeResponse) Descriptor() ([]byte, []int) {
	return file_fx_gravity_crosschain_v1_legacy_proto_rawDescGZIP(), []int{17}
}

func (x *QueryBatchFeeResponse) GetBatchFees() []*BatchFees {
	if x != nil {
		return x.BatchFees
	}
	return nil
...
var file_fx_gravity_crosschain_v1_legacy_proto_rawDesc = []byte{
	...
	,
	...
	0x49, 0x6e, 0x74, 0x52, 0x09, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x46, 0x65, 0x65, 0x73, 0x12, 0x1b,
	0x0a, 0x09, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x74, 0x78, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x08, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x54, 0x78, 0x73, 0x12, 0x4e, 0x0a, 0x0c, 0x74,
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x3a, 0x02, 0x18, 0x01, 0x22,
	0x80, 0x01, 0x0a, 0x0b, 0x4d, 0x69, 0x6e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x46, 0x65, 0x65, 0x12,
	...
	,
	...
	0x46, 0x78, 0x3a, 0x3a, 0x47, 0x72, 0x61, 0x76, 0x69, 0x74, 0x79, 0x3a, 0x3a, 0x43, 0x72, 0x6f,
...
var file_fx_gravity_crosschain_v1_legacy_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_fx_gravity_crosschain_v1_legacy_proto_goTypes = []interface{}{
	...
	(*BridgeToken)(nil),                  // 13: fx.gravity.crosschain.v1.BridgeToken
	(*BatchFees)(nil),                    // 14: fx.gravity.crosschain.v1.BatchFees
	(*MinBatchFee)(nil),                  // 15: fx.gravity.crosschain.v1.MinBatchFee
	(*QueryBatchFeeRequest)(nil),         // 16: fx.gravity.crosschain.v1.QueryBatchFeeRequest
	(*QueryBatchFeeResponse)(nil),        // 17: fx.gravity.crosschain.v1.QueryBatchFeeResponse
	(*Params)(nil),                       // 18: fx.gravity.crosschain.v1.Params
	(*v1beta1.Coin)(nil),                 // 19: cosmos.base.v1beta1.Coin
}
var file_fx_gravity_crosschain_v1_legacy_proto_depIdxs = []int32{
	18, // 0: fx.gravity.crosschain.v1.InitCrossChainParamsProposal.params:type_name -> fx.gravity.crosschain.v1.Params
	19, // 1: fx.gravity.crosschain.v1.MsgSetOrchestratorAddress.deposit:type_name -> cosmos.base.v1beta1.Coin
	19, // 2: fx.gravity.crosschain.v1.MsgAddOracleDeposit.amount:type_name -> cosmos.base.v1beta1.Coin
	19, // 3: fx.gravity.crosschain.v1.MsgSendToExternal.amount:type_name -> cosmos.base.v1beta1.Coin
	19, // 4: fx.gravity.crosschain.v1.MsgSendToExternal.bridge_fee:type_name -> cosmos.base.v1beta1.Coin
	19, // 5: fx.gravity.crosschain.v1.MsgIncreaseBridgeFee.add_bridge_fee:type_name -> cosmos.base.v1beta1.Coin
	15, // 6: fx.gravity.crosschain.v1.QueryBatchFeeRequest.min_batch_fees:type_name -> fx.gravity.crosschain.v1.MinBatchFee
	14, // 7: fx.gravity.crosschain.v1.QueryBatchFeeResponse.batch_fees:type_name -> fx.gravity.crosschain.v1.BatchFees
...
func file_fx_gravity_crosschain_v1_legacy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MinBatchFee); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryBatchFeeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_fx_gravity_crosschain_v1_legacy_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryBatchFeeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
