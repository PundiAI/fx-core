...
//
// Solidity: function bridgeCall(string _dstChain, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _message, uint256 _value) payable returns(bool _result)
func (_ICrossChain *ICrossChainTransactor) BridgeCall(opts *bind.TransactOpts, _dstChain string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _message []byte, _value *big.Int) (*types.Transaction, error) {
	return _ICrossChain.contract.Transact(opts, "bridgeCall", _dstChain, _gasLimit, _receiver, _to, _tokens, _amounts, _message, _value)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x251477c7.
//
// Solidity: function bridgeCall(string _dstChain, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _message, uint256 _value) payable returns(bool _result)
func (_ICrossChain *ICrossChainSession) BridgeCall(_dstChain string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _message []byte, _value *big.Int) (*types.Transaction, error) {
	return _ICrossChain.Contract.BridgeCall(&_ICrossChain.TransactOpts, _dstChain, _gasLimit, _receiver, _to, _tokens, _amounts, _message, _value)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x251477c7.
//
// Solidity: function bridgeCall(string _dstChain, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _message, uint256 _value) payable returns(bool _result)
func (_ICrossChain *ICrossChainTransactorSession) BridgeCall(_dstChain string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _message []byte, _value *big.Int) (*types.Transaction, error) {
	return _ICrossChain.Contract.BridgeCall(&_ICrossChain.TransactOpts, _dstChain, _gasLimit, _receiver, _to, _tokens, _amounts, _message, _value)
}
...
// FilterBridgeCallEvent is a free log retrieval operation binding the contract event 0x492651e772c0ac697aa91e7e160471e5912d6472d8c0e2a5b58d91e7baf8f56a.
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, uint256 _eventNonce, string _dstChain, uint256 _gasLimit, uint256 _value, bytes _message, address[] _tokens, uint256[] _amounts)
...
// WatchBridgeCallEvent is a free log subscription operation binding the contract event 0x492651e772c0ac697aa91e7e160471e5912d6472d8c0e2a5b58d91e7baf8f56a.
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, uint256 _eventNonce, string _dstChain, uint256 _gasLimit, uint256 _value, bytes _message, address[] _tokens, uint256[] _amounts)
...
// ParseBridgeCallEvent is a log parse operation binding the contract event 0x492651e772c0ac697aa91e7e160471e5912d6472d8c0e2a5b58d91e7baf8f56a.
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, uint256 _eventNonce, string _dstChain, uint256 _gasLimit, uint256 _value, bytes _message, address[] _tokens, uint256[] _amounts)
