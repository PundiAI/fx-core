...
//
// Solidity: function bridgeCall(string _dstChainId, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _message, uint256 _value) payable returns(bool _result)
func (_ICrossChain *ICrossChainTransactor) BridgeCall(opts *bind.TransactOpts, _dstChainId string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _message []byte, _value *big.Int) (*types.Transaction, error) {
	return _ICrossChain.contract.Transact(opts, "bridgeCall", _dstChainId, _gasLimit, _receiver, _to, _tokens, _amounts, _message, _value)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x251477c7.
//
// Solidity: function bridgeCall(string _dstChainId, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _message, uint256 _value) payable returns(bool _result)
func (_ICrossChain *ICrossChainSession) BridgeCall(_dstChainId string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _message []byte, _value *big.Int) (*types.Transaction, error) {
	return _ICrossChain.Contract.BridgeCall(&_ICrossChain.TransactOpts, _dstChainId, _gasLimit, _receiver, _to, _tokens, _amounts, _message, _value)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x251477c7.
//
// Solidity: function bridgeCall(string _dstChainId, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _message, uint256 _value) payable returns(bool _result)
func (_ICrossChain *ICrossChainTransactorSession) BridgeCall(_dstChainId string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _message []byte, _value *big.Int) (*types.Transaction, error) {
	return _ICrossChain.Contract.BridgeCall(&_ICrossChain.TransactOpts, _dstChainId, _gasLimit, _receiver, _to, _tokens, _amounts, _message, _value)
}
...
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, uint256 _eventNonce, string _dstChainId, uint256 _gasLimit, uint256 _value, bytes _message, address[] _tokens, uint256[] _amounts)
