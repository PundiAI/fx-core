...
//
// Solidity: function tokenStatus(address _tokenAddr) view returns(bool isOriginated, bool isActive, bool isExist)
func (_IFxBridgeLogic *IFxBridgeLogicCaller) TokenStatus(opts *bind.CallOpts, _tokenAddr common.Address) (struct {
	IsOriginated bool
	IsActive     bool
	IsExist      bool
}, error) {
...
//
// Solidity: function tokenStatus(address _tokenAddr) view returns(bool isOriginated, bool isActive, bool isExist)
func (_IFxBridgeLogic *IFxBridgeLogicSession) TokenStatus(_tokenAddr common.Address) (struct {
	IsOriginated bool
	IsActive     bool
	IsExist      bool
}, error) {
...
//
// Solidity: function tokenStatus(address _tokenAddr) view returns(bool isOriginated, bool isActive, bool isExist)
func (_IFxBridgeLogic *IFxBridgeLogicCallerSession) TokenStatus(_tokenAddr common.Address) (struct {
	IsOriginated bool
	IsActive     bool
	IsExist      bool
}, error) {
...
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) AddBridgeToken(opts *bind.TransactOpts, _tokenAddr common.Address, _memo [32]byte, _isOriginated bool) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "addBridgeToken", _tokenAddr, _memo, _isOriginated)
}
...
func (_IFxBridgeLogic *IFxBridgeLogicSession) AddBridgeToken(_tokenAddr common.Address, _memo [32]byte, _isOriginated bool) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.AddBridgeToken(&_IFxBridgeLogic.TransactOpts, _tokenAddr, _memo, _isOriginated)
}
