...
//
// Solidity: function bridgeCall(string _dstChain, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _message, uint256 _value) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) BridgeCall(opts *bind.TransactOpts, _dstChain string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _message []byte, _value *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "bridgeCall", _dstChain, _gasLimit, _receiver, _to, _tokens, _amounts, _message, _value)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x251477c7.
//
// Solidity: function bridgeCall(string _dstChain, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _message, uint256 _value) returns()
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeCall(_dstChain string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _message []byte, _value *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChain, _gasLimit, _receiver, _to, _tokens, _amounts, _message, _value)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x251477c7.
//
// Solidity: function bridgeCall(string _dstChain, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _message, uint256 _value) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactorSession) BridgeCall(_dstChain string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _message []byte, _value *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChain, _gasLimit, _receiver, _to, _tokens, _amounts, _message, _value)
}

// BridgeCallCheckpoint is a paid mutator transaction binding the contract method 0x9232b08e.
//
// Solidity: function bridgeCallCheckpoint(bytes32 _fxbridgeId, bytes32 _methodName, address _sender, address _to, address _receiver, uint256 _value, uint256 _nonce, uint256 _gasLimit, uint256 _timeout, bytes _message, address[] _tokens, uint256[] _amounts) returns(bytes32)
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) BridgeCallCheckpoint(opts *bind.TransactOpts, _fxbridgeId [32]byte, _methodName [32]byte, _sender common.Address, _to common.Address, _receiver common.Address, _value *big.Int, _nonce *big.Int, _gasLimit *big.Int, _timeout *big.Int, _message []byte, _tokens []common.Address, _amounts []*big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "bridgeCallCheckpoint", _fxbridgeId, _methodName, _sender, _to, _receiver, _value, _nonce, _gasLimit, _timeout, _message, _tokens, _amounts)
}

// BridgeCallCheckpoint is a paid mutator transaction binding the contract method 0x9232b08e.
//
// Solidity: function bridgeCallCheckpoint(bytes32 _fxbridgeId, bytes32 _methodName, address _sender, address _to, address _receiver, uint256 _value, uint256 _nonce, uint256 _gasLimit, uint256 _timeout, bytes _message, address[] _tokens, uint256[] _amounts) returns(bytes32)
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeCallCheckpoint(_fxbridgeId [32]byte, _methodName [32]byte, _sender common.Address, _to common.Address, _receiver common.Address, _value *big.Int, _nonce *big.Int, _gasLimit *big.Int, _timeout *big.Int, _message []byte, _tokens []common.Address, _amounts []*big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCallCheckpoint(&_IFxBridgeLogic.TransactOpts, _fxbridgeId, _methodName, _sender, _to, _receiver, _value, _nonce, _gasLimit, _timeout, _message, _tokens, _amounts)
}
...
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address[] _tokens, uint256[] _amounts, uint256 _eventNonce, string _dstChain, uint256 _gasLimit, bytes _message, uint256 _value)
