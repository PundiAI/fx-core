...
// BridgeCall is a paid mutator transaction binding the contract method 0x4456db61.
//
// Solidity: function bridgeCall(string _dstChain, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _data, uint256 _value, bytes _memo) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) BridgeCall(opts *bind.TransactOpts, _dstChain string, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _data []byte, _value *big.Int, _memo []byte) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "bridgeCall", _dstChain, _receiver, _to, _tokens, _amounts, _data, _value, _memo)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x4456db61.
//
// Solidity: function bridgeCall(string _dstChain, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _data, uint256 _value, bytes _memo) returns()
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeCall(_dstChain string, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _data []byte, _value *big.Int, _memo []byte) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChain, _receiver, _to, _tokens, _amounts, _data, _value, _memo)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x4456db61.
//
// Solidity: function bridgeCall(string _dstChain, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _data, uint256 _value, bytes _memo) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactorSession) BridgeCall(_dstChain string, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _data []byte, _value *big.Int, _memo []byte) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChain, _receiver, _to, _tokens, _amounts, _data, _value, _memo)
}
...
// FilterBridgeCallEvent is a free log retrieval operation binding the contract event 0xc999aac3cf98c7e9b65e778ac420c158f9cbdc61f2a18263afaa231faa649b21.
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address[] _tokens, uint256[] _amounts, uint256 _eventNonce, string _dstChain, bytes _data, uint256 _value, bytes _memo)
...
// WatchBridgeCallEvent is a free log subscription operation binding the contract event 0xc999aac3cf98c7e9b65e778ac420c158f9cbdc61f2a18263afaa231faa649b21.
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address[] _tokens, uint256[] _amounts, uint256 _eventNonce, string _dstChain, bytes _data, uint256 _value, bytes _memo)
...
// ParseBridgeCallEvent is a log parse operation binding the contract event 0xc999aac3cf98c7e9b65e778ac420c158f9cbdc61f2a18263afaa231faa649b21.
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address[] _tokens, uint256[] _amounts, uint256 _eventNonce, string _dstChain, bytes _data, uint256 _value, bytes _memo)
