...
// BridgeCallCheckpoint is a paid mutator transaction binding the contract method 0xae0b5cf0.
//
// Solidity: function bridgeCallCheckpoint(bytes32 _fxbridgeId, bytes32 _methodName, address _sender, address _to, address _receiver, uint256 _value, uint256 _nonce, uint256 _gasLimit, uint256 _timeout, string _dstChain, bytes _message, address[] _tokens, uint256[] _amounts) returns(bytes32)
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) BridgeCallCheckpoint(opts *bind.TransactOpts, _fxbridgeId [32]byte, _methodName [32]byte, _sender common.Address, _to common.Address, _receiver common.Address, _value *big.Int, _nonce *big.Int, _gasLimit *big.Int, _timeout *big.Int, _dstChain string, _message []byte, _tokens []common.Address, _amounts []*big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "bridgeCallCheckpoint", _fxbridgeId, _methodName, _sender, _to, _receiver, _value, _nonce, _gasLimit, _timeout, _dstChain, _message, _tokens, _amounts)
}

// BridgeCallCheckpoint is a paid mutator transaction binding the contract method 0xae0b5cf0.
//
// Solidity: function bridgeCallCheckpoint(bytes32 _fxbridgeId, bytes32 _methodName, address _sender, address _to, address _receiver, uint256 _value, uint256 _nonce, uint256 _gasLimit, uint256 _timeout, string _dstChain, bytes _message, address[] _tokens, uint256[] _amounts) returns(bytes32)
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeCallCheckpoint(_fxbridgeId [32]byte, _methodName [32]byte, _sender common.Address, _to common.Address, _receiver common.Address, _value *big.Int, _nonce *big.Int, _gasLimit *big.Int, _timeout *big.Int, _dstChain string, _message []byte, _tokens []common.Address, _amounts []*big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCallCheckpoint(&_IFxBridgeLogic.TransactOpts, _fxbridgeId, _methodName, _sender, _to, _receiver, _value, _nonce, _gasLimit, _timeout, _dstChain, _message, _tokens, _amounts)
}
