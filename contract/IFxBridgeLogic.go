...
//
// Solidity: function bridgeCall(string _dstChain, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _data, uint256 _value) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) BridgeCall(opts *bind.TransactOpts, _dstChain string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _data []byte, _value *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "bridgeCall", _dstChain, _gasLimit, _receiver, _to, _tokens, _amounts, _data, _value)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x251477c7.
//
// Solidity: function bridgeCall(string _dstChain, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _data, uint256 _value) returns()
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeCall(_dstChain string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _data []byte, _value *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChain, _gasLimit, _receiver, _to, _tokens, _amounts, _data, _value)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x251477c7.
//
// Solidity: function bridgeCall(string _dstChain, uint256 _gasLimit, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _data, uint256 _value) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactorSession) BridgeCall(_dstChain string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _data []byte, _value *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChain, _gasLimit, _receiver, _to, _tokens, _amounts, _data, _value)
}
...
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address[] _tokens, uint256[] _amounts, uint256 _eventNonce, string _dstChain, uint256 _gasLimit, bytes _data, uint256 _value)
