...
func (_IFxBridgeLogic *IFxBridgeLogicCaller) BridgeTokens(opts *bind.CallOpts, _index *big.Int) (common.Address, error) {
	var out []interface{}
	err := _IFxBridgeLogic.contract.Call(opts, &out, "bridgeTokens", _index)
...
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeTokens(_index *big.Int) (common.Address, error) {
	return _IFxBridgeLogic.Contract.BridgeTokens(&_IFxBridgeLogic.CallOpts, _index)
}
...
func (_IFxBridgeLogic *IFxBridgeLogicCaller) StateLastBridgeCallNonces(opts *bind.CallOpts, _index *big.Int) (bool, error) {
	var out []interface{}
	err := _IFxBridgeLogic.contract.Call(opts, &out, "state_lastBridgeCallNonces", _index)
...
func (_IFxBridgeLogic *IFxBridgeLogicSession) StateLastBridgeCallNonces(_index *big.Int) (bool, error) {
	return _IFxBridgeLogic.Contract.StateLastBridgeCallNonces(&_IFxBridgeLogic.CallOpts, _index)
}
...
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) AddBridgeToken(opts *bind.TransactOpts, _tokenAddr common.Address, _channelIBC [32]byte, _isOriginated bool) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "addBridgeToken", _tokenAddr, _channelIBC, _isOriginated)
}
...
func (_IFxBridgeLogic *IFxBridgeLogicSession) AddBridgeToken(_tokenAddr common.Address, _channelIBC [32]byte, _isOriginated bool) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.AddBridgeToken(&_IFxBridgeLogic.TransactOpts, _tokenAddr, _channelIBC, _isOriginated)
}
...
// BridgeCall is a paid mutator transaction binding the contract method 0xfde272e2.
//
// Solidity: function bridgeCall(string _dstChain, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _data, uint256 _value) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) BridgeCall(opts *bind.TransactOpts, _dstChain string, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _data []byte, _value *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "bridgeCall", _dstChain, _receiver, _to, _tokens, _amounts, _data, _value)
}

// BridgeCall is a paid mutator transaction binding the contract method 0xfde272e2.
//
// Solidity: function bridgeCall(string _dstChain, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _data, uint256 _value) returns()
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeCall(_dstChain string, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _data []byte, _value *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChain, _receiver, _to, _tokens, _amounts, _data, _value)
}

// BridgeCall is a paid mutator transaction binding the contract method 0xfde272e2.
//
// Solidity: function bridgeCall(string _dstChain, address _receiver, address _to, address[] _tokens, uint256[] _amounts, bytes _data, uint256 _value) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactorSession) BridgeCall(_dstChain string, _receiver common.Address, _to common.Address, _tokens []common.Address, _amounts []*big.Int, _data []byte, _value *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChain, _receiver, _to, _tokens, _amounts, _data, _value)
}

// BridgeCallCheckpoint is a paid mutator transaction binding the contract method 0x9232b08e.
//
// Solidity: function bridgeCallCheckpoint(bytes32 _fxbridgeId, bytes32 _methodName, address _sender, address _to, address _receiver, uint256 _value, uint256 _nonce, uint256 _gasLimit, uint256 _timeout, bytes _data, address[] _tokens, uint256[] _amounts) returns(bytes32)
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) BridgeCallCheckpoint(opts *bind.TransactOpts, _fxbridgeId [32]byte, _methodName [32]byte, _sender common.Address, _to common.Address, _receiver common.Address, _value *big.Int, _nonce *big.Int, _gasLimit *big.Int, _timeout *big.Int, _data []byte, _tokens []common.Address, _amounts []*big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "bridgeCallCheckpoint", _fxbridgeId, _methodName, _sender, _to, _receiver, _value, _nonce, _gasLimit, _timeout, _data, _tokens, _amounts)
}

// BridgeCallCheckpoint is a paid mutator transaction binding the contract method 0x9232b08e.
//
// Solidity: function bridgeCallCheckpoint(bytes32 _fxbridgeId, bytes32 _methodName, address _sender, address _to, address _receiver, uint256 _value, uint256 _nonce, uint256 _gasLimit, uint256 _timeout, bytes _data, address[] _tokens, uint256[] _amounts) returns(bytes32)
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeCallCheckpoint(_fxbridgeId [32]byte, _methodName [32]byte, _sender common.Address, _to common.Address, _receiver common.Address, _value *big.Int, _nonce *big.Int, _gasLimit *big.Int, _timeout *big.Int, _data []byte, _tokens []common.Address, _amounts []*big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCallCheckpoint(&_IFxBridgeLogic.TransactOpts, _fxbridgeId, _methodName, _sender, _to, _receiver, _value, _nonce, _gasLimit, _timeout, _data, _tokens, _amounts)
}
...
// FilterBridgeCallEvent is a free log retrieval operation binding the contract event 0xc55cb7ea3eb2d24c9360326914f2616c6be2b048add2901d87dd2a7cec6d93f4.
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address[] _tokens, uint256[] _amounts, uint256 _eventNonce, string _dstChain, bytes _data, uint256 _value)
...
// WatchBridgeCallEvent is a free log subscription operation binding the contract event 0xc55cb7ea3eb2d24c9360326914f2616c6be2b048add2901d87dd2a7cec6d93f4.
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address[] _tokens, uint256[] _amounts, uint256 _eventNonce, string _dstChain, bytes _data, uint256 _value)
...
// ParseBridgeCallEvent is a log parse operation binding the contract event 0xc55cb7ea3eb2d24c9360326914f2616c6be2b048add2901d87dd2a7cec6d93f4.
//
// Solidity: event BridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address[] _tokens, uint256[] _amounts, uint256 _eventNonce, string _dstChain, bytes _data, uint256 _value)
