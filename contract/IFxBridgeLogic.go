...
// DecodeAsset is a free data retrieval call binding the contract method 0xef64127c.
//
// Solidity: function decodeAsset(bytes _data) pure returns(address[], uint256[])
func (_IFxBridgeLogic *IFxBridgeLogicCaller) DecodeAsset(opts *bind.CallOpts, _data []byte) ([]common.Address, []*big.Int, error) {
	var out []interface{}
	err := _IFxBridgeLogic.contract.Call(opts, &out, "decodeAsset", _data)
...
//
// Solidity: function decodeAsset(bytes _data) pure returns(address[], uint256[])
func (_IFxBridgeLogic *IFxBridgeLogicSession) DecodeAsset(_data []byte) ([]common.Address, []*big.Int, error) {
	return _IFxBridgeLogic.Contract.DecodeAsset(&_IFxBridgeLogic.CallOpts, _data)
}

// DecodeAsset is a free data retrieval call binding the contract method 0xef64127c.
//
// Solidity: function decodeAsset(bytes _data) pure returns(address[], uint256[])
func (_IFxBridgeLogic *IFxBridgeLogicCallerSession) DecodeAsset(_data []byte) ([]common.Address, []*big.Int, error) {
	return _IFxBridgeLogic.Contract.DecodeAsset(&_IFxBridgeLogic.CallOpts, _data)
}

// EncodeAsset is a free data retrieval call binding the contract method 0xd982c393.
//
// Solidity: function encodeAsset(address[] _token, uint256[] _amount) pure returns(bytes)
func (_IFxBridgeLogic *IFxBridgeLogicCaller) EncodeAsset(opts *bind.CallOpts, _token []common.Address, _amount []*big.Int) ([]byte, error) {
	var out []interface{}
	err := _IFxBridgeLogic.contract.Call(opts, &out, "encodeAsset", _token, _amount)
...
//
// Solidity: function encodeAsset(address[] _token, uint256[] _amount) pure returns(bytes)
func (_IFxBridgeLogic *IFxBridgeLogicSession) EncodeAsset(_token []common.Address, _amount []*big.Int) ([]byte, error) {
	return _IFxBridgeLogic.Contract.EncodeAsset(&_IFxBridgeLogic.CallOpts, _token, _amount)
}

// EncodeAsset is a free data retrieval call binding the contract method 0xd982c393.
//
// Solidity: function encodeAsset(address[] _token, uint256[] _amount) pure returns(bytes)
func (_IFxBridgeLogic *IFxBridgeLogicCallerSession) EncodeAsset(_token []common.Address, _amount []*big.Int) ([]byte, error) {
	return _IFxBridgeLogic.Contract.EncodeAsset(&_IFxBridgeLogic.CallOpts, _token, _amount)
}
...
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) BridgeCall(opts *bind.TransactOpts, _dstChainId string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _message []byte, _value *big.Int, _asset []byte) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "bridgeCall", _dstChainId, _gasLimit, _receiver, _to, _message, _value, _asset)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x6907f2e6.
//
// Solidity: function bridgeCall(string _dstChainId, uint256 _gasLimit, address _receiver, address _to, bytes _message, uint256 _value, bytes _asset) returns()
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeCall(_dstChainId string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _message []byte, _value *big.Int, _asset []byte) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChainId, _gasLimit, _receiver, _to, _message, _value, _asset)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x6907f2e6.
//
// Solidity: function bridgeCall(string _dstChainId, uint256 _gasLimit, address _receiver, address _to, bytes _message, uint256 _value, bytes _asset) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactorSession) BridgeCall(_dstChainId string, _gasLimit *big.Int, _receiver common.Address, _to common.Address, _message []byte, _value *big.Int, _asset []byte) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChainId, _gasLimit, _receiver, _to, _message, _value, _asset)
}
...
// SubmitBridgeCall is a paid mutator transaction binding the contract method 0xb59524a8.
//
// Solidity: function submitBridgeCall(address[] _currentOracles, uint256[] _currentPowers, uint8[] _v, bytes32[] _r, bytes32[] _s, uint256[2] _nonceArray, (address,address,address,uint256,bytes,bytes,uint256,uint256) _input) returns()
...
// FilterSubmitBridgeCallEvent is a free log retrieval operation binding the contract event 0x53448d6cef9dd030d3c6e43027d06f8c61042e6a5d932f007bfc5fc50e4073d0.
//
// Solidity: event SubmitBridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, uint256 _eventNonce, bool _result)
...
// WatchSubmitBridgeCallEvent is a free log subscription operation binding the contract event 0x53448d6cef9dd030d3c6e43027d06f8c61042e6a5d932f007bfc5fc50e4073d0.
//
// Solidity: event SubmitBridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, uint256 _eventNonce, bool _result)
...
// ParseSubmitBridgeCallEvent is a log parse operation binding the contract event 0x53448d6cef9dd030d3c6e43027d06f8c61042e6a5d932f007bfc5fc50e4073d0.
//
// Solidity: event SubmitBridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, uint256 _eventNonce, bool _result)
