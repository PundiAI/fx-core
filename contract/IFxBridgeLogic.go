...
func (_IFxBridgeLogic *IFxBridgeLogicCaller) DecodeType(opts *bind.CallOpts, _asset []byte) (string, []byte, error) {
	var out []interface{}
	err := _IFxBridgeLogic.contract.Call(opts, &out, "decodeType", _asset)
...
//
// Solidity: function decodeType(bytes _asset) pure returns(string, bytes)
func (_IFxBridgeLogic *IFxBridgeLogicSession) DecodeType(_asset []byte) (string, []byte, error) {
	return _IFxBridgeLogic.Contract.DecodeType(&_IFxBridgeLogic.CallOpts, _asset)
}

// DecodeType is a free data retrieval call binding the contract method 0x4157a36c.
//
// Solidity: function decodeType(bytes _asset) pure returns(string, bytes)
func (_IFxBridgeLogic *IFxBridgeLogicCallerSession) DecodeType(_asset []byte) (string, []byte, error) {
	return _IFxBridgeLogic.Contract.DecodeType(&_IFxBridgeLogic.CallOpts, _asset)
}
