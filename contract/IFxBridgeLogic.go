...
//
// Solidity: function bridgeCall(string _dstChain, address _receiver, address[] _tokens, uint256[] _amounts, address _to, bytes _data, uint256 _value, bytes _memo) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) BridgeCall(opts *bind.TransactOpts, _dstChain string, _receiver common.Address, _tokens []common.Address, _amounts []*big.Int, _to common.Address, _data []byte, _value *big.Int, _memo []byte) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "bridgeCall", _dstChain, _receiver, _tokens, _amounts, _to, _data, _value, _memo)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x851c42ee.
//
// Solidity: function bridgeCall(string _dstChain, address _receiver, address[] _tokens, uint256[] _amounts, address _to, bytes _data, uint256 _value, bytes _memo) returns()
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeCall(_dstChain string, _receiver common.Address, _tokens []common.Address, _amounts []*big.Int, _to common.Address, _data []byte, _value *big.Int, _memo []byte) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChain, _receiver, _tokens, _amounts, _to, _data, _value, _memo)
}

// BridgeCall is a paid mutator transaction binding the contract method 0x851c42ee.
//
// Solidity: function bridgeCall(string _dstChain, address _receiver, address[] _tokens, uint256[] _amounts, address _to, bytes _data, uint256 _value, bytes _memo) returns()
func (_IFxBridgeLogic *IFxBridgeLogicTransactorSession) BridgeCall(_dstChain string, _receiver common.Address, _tokens []common.Address, _amounts []*big.Int, _to common.Address, _data []byte, _value *big.Int, _memo []byte) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCall(&_IFxBridgeLogic.TransactOpts, _dstChain, _receiver, _tokens, _amounts, _to, _data, _value, _memo)
}

// BridgeCallCheckpoint is a paid mutator transaction binding the contract method 0x484af95a.
//
// Solidity: function bridgeCallCheckpoint(bytes32 _fxbridgeId, bytes32 _methodName, address _sender, address _receiver, address[] _tokens, uint256[] _amounts, address _to, bytes _data, bytes _memo, uint256 _nonce, uint256 _timeout) returns(bytes32)
func (_IFxBridgeLogic *IFxBridgeLogicTransactor) BridgeCallCheckpoint(opts *bind.TransactOpts, _fxbridgeId [32]byte, _methodName [32]byte, _sender common.Address, _receiver common.Address, _tokens []common.Address, _amounts []*big.Int, _to common.Address, _data []byte, _memo []byte, _nonce *big.Int, _timeout *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.contract.Transact(opts, "bridgeCallCheckpoint", _fxbridgeId, _methodName, _sender, _receiver, _tokens, _amounts, _to, _data, _memo, _nonce, _timeout)
}

// BridgeCallCheckpoint is a paid mutator transaction binding the contract method 0x484af95a.
//
// Solidity: function bridgeCallCheckpoint(bytes32 _fxbridgeId, bytes32 _methodName, address _sender, address _receiver, address[] _tokens, uint256[] _amounts, address _to, bytes _data, bytes _memo, uint256 _nonce, uint256 _timeout) returns(bytes32)
func (_IFxBridgeLogic *IFxBridgeLogicSession) BridgeCallCheckpoint(_fxbridgeId [32]byte, _methodName [32]byte, _sender common.Address, _receiver common.Address, _tokens []common.Address, _amounts []*big.Int, _to common.Address, _data []byte, _memo []byte, _nonce *big.Int, _timeout *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCallCheckpoint(&_IFxBridgeLogic.TransactOpts, _fxbridgeId, _methodName, _sender, _receiver, _tokens, _amounts, _to, _data, _memo, _nonce, _timeout)
}

// BridgeCallCheckpoint is a paid mutator transaction binding the contract method 0x484af95a.
//
// Solidity: function bridgeCallCheckpoint(bytes32 _fxbridgeId, bytes32 _methodName, address _sender, address _receiver, address[] _tokens, uint256[] _amounts, address _to, bytes _data, bytes _memo, uint256 _nonce, uint256 _timeout) returns(bytes32)
func (_IFxBridgeLogic *IFxBridgeLogicTransactorSession) BridgeCallCheckpoint(_fxbridgeId [32]byte, _methodName [32]byte, _sender common.Address, _receiver common.Address, _tokens []common.Address, _amounts []*big.Int, _to common.Address, _data []byte, _memo []byte, _nonce *big.Int, _timeout *big.Int) (*types.Transaction, error) {
	return _IFxBridgeLogic.Contract.BridgeCallCheckpoint(&_IFxBridgeLogic.TransactOpts, _fxbridgeId, _methodName, _sender, _receiver, _tokens, _amounts, _to, _data, _memo, _nonce, _timeout)
}
...
// SubmitBridgeCall is a paid mutator transaction binding the contract method 0xcb809df1.
//
// Solidity: function submitBridgeCall(address[] _currentOracles, uint256[] _currentPowers, uint8[] _v, bytes32[] _r, bytes32[] _s, uint256[2] _nonceArray, (address,address,address[],uint256[],address,bytes,bytes,uint256) _input) returns()
...
// FilterSubmitBridgeCallEvent is a free log retrieval operation binding the contract event 0x81350ffac62df257c99e23e0738671f18dd6b2cad1383dd097e7f1ff3ac1cdc5.
//
// Solidity: event SubmitBridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address _txOrigin, uint256 _nonce, uint256 _eventNonce, bool _success, bytes _cause)
...
// WatchSubmitBridgeCallEvent is a free log subscription operation binding the contract event 0x81350ffac62df257c99e23e0738671f18dd6b2cad1383dd097e7f1ff3ac1cdc5.
//
// Solidity: event SubmitBridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address _txOrigin, uint256 _nonce, uint256 _eventNonce, bool _success, bytes _cause)
...
// ParseSubmitBridgeCallEvent is a log parse operation binding the contract event 0x81350ffac62df257c99e23e0738671f18dd6b2cad1383dd097e7f1ff3ac1cdc5.
//
// Solidity: event SubmitBridgeCallEvent(address indexed _sender, address indexed _receiver, address indexed _to, address _txOrigin, uint256 _nonce, uint256 _eventNonce, bool _success, bytes _cause)
