...
func (_ICrosschain *ICrosschainCaller) GetERC20Token(opts *bind.CallOpts, _denom [32]byte) (struct {
	Token  common.Address
	Enable bool
}, error) {
	var out []interface{}
	err := _ICrosschain.contract.Call(opts, &out, "getERC20Token", _denom)
...
//
// Solidity: function getERC20Token(bytes32 _denom) view returns(address _token, bool _enable)
func (_ICrosschain *ICrosschainSession) GetERC20Token(_denom [32]byte) (struct {
	Token  common.Address
	Enable bool
}, error) {
	return _ICrosschain.Contract.GetERC20Token(&_ICrosschain.CallOpts, _denom)
}

// GetERC20Token is a free data retrieval call binding the contract method 0xe8e1f205.
//
// Solidity: function getERC20Token(bytes32 _denom) view returns(address _token, bool _enable)
func (_ICrosschain *ICrosschainCallerSession) GetERC20Token(_denom [32]byte) (struct {
	Token  common.Address
	Enable bool
}, error) {
	return _ICrosschain.Contract.GetERC20Token(&_ICrosschain.CallOpts, _denom)
