...
func (_AccessControl *AccessControlTransactor) Initialize(opts *bind.TransactOpts, _admin common.Address) (*types.Transaction, error) {
	return _AccessControl.contract.Transact(opts, "initialize", _admin)
}
...
func (_AccessControl *AccessControlSession) Initialize(_admin common.Address) (*types.Transaction, error) {
	return _AccessControl.Contract.Initialize(&_AccessControl.TransactOpts, _admin)
}
...
type AccessControlInitializedIterator struct {
	Event *AccessControlInitialized // Event containing the contract specifics and raw log
...
func (it *AccessControlInitializedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(AccessControlInitialized)
...
type AccessControlInitialized struct {
	Version uint8
...
func (_AccessControl *AccessControlFilterer) FilterInitialized(opts *bind.FilterOpts) (*AccessControlInitializedIterator, error) {
	...
	logs, sub, err := _AccessControl.contract.FilterLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return &AccessControlInitializedIterator{contract: _AccessControl.contract, event: "Initialized", logs: logs, sub: sub}, nil
}
...
func (_AccessControl *AccessControlFilterer) WatchInitialized(opts *bind.WatchOpts, sink chan<- *AccessControlInitialized) (event.Subscription, error) {
	...
	logs, sub, err := _AccessControl.contract.WatchLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(AccessControlInitialized)
				if err := _AccessControl.contract.UnpackLog(event, "Initialized", log); err != nil {
					return err
				}
				event.Raw = log
