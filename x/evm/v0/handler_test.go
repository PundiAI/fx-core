...
import (
	...
	fxcore "github.com/functionx/fx-core/app"
	"github.com/functionx/fx-core/crypto/ethsecp256k1"
	"github.com/functionx/fx-core/tests"
	"github.com/functionx/fx-core/x/evm/v0"
...
func (suite *EvmTestSuite) DoSetupTest(t require.TestingT) {
	...
	suite.app.EvmKeeperV0.SetAddressCode(suite.ctx, address, common.BytesToHash(crypto.Keccak256(nil)).Bytes())
	...
	suite.handler = evm.NewHandler(suite.app.EvmKeeperV0)
}
...
func (suite *EvmTestSuite) TestHandlerLogs() {
	...
	for _, log := range tlogs {
		suite.app.EvmKeeperV0.AddLogTransient(log)
	}
	suite.Require().NoError(err)

	logs := suite.app.EvmKeeperV0.GetTxLogsTransient(tlogs[0].TxHash)
