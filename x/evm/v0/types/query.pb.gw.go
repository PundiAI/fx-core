...
var (
	...
	pattern_Query_ModuleEnable_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ethermint", "evm", "v1", "module_enable"}, "", runtime.AssumeColonVerbOpt(true)))
)
