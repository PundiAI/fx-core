...
func (k Keeper) QueryERC20(ctx sdk.Context, contractAddr common.Address) (types.ERC20Data, error) {
	...
	err := k.evmKeeper.QueryContract(ctx, k.moduleAddress, contractAddr, erc20, "name", &nameRes)
	if err != nil {
	...
	err = k.evmKeeper.QueryContract(ctx, k.moduleAddress, contractAddr, erc20, "symbol", &symbolRes)
	if err != nil {
		return types.ERC20Data{}, err
	}
	...
	err = k.evmKeeper.QueryContract(ctx, k.moduleAddress, contractAddr, erc20, "decimals", &decimalRes)
	if err != nil {
		return types.ERC20Data{}, err
	}
