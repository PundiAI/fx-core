...
func (k Keeper) GetEnableErc20(ctx sdk.Context) bool {
	...
	k.paramstore.GetIfExists(ctx, types.ParamStoreKeyEnableErc20, &enableErc20)
	return enableErc20
}
...
func (k Keeper) GetEnableEVMHook(ctx sdk.Context) bool {
	...
	k.paramstore.GetIfExists(ctx, types.ParamStoreKeyEnableEVMHook, &enableEVMHook)
...
func (k Keeper) GetIbcTimeout(ctx sdk.Context) time.Duration {
	...
	k.paramstore.GetIfExists(ctx, types.ParamStoreKeyIBCTimeout, &ibcTimeout)
	return ibcTimeout
}
