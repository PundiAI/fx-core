...
func TestValidateExternalAddress(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			value:      "abcdddddd",
			expectPass: false,
			err:        fmt.Errorf("address (%s) of the wrong length exp (%d) actual (%d): invalid", "abcdddddd", len("abcdddddd"), TronContractAddressLen),
		},
		{
			testName:   "address length great than tron address",
			value:      "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t6666",
			expectPass: false,
			err:        fmt.Errorf("address (%s) of the wrong length exp (%d) actual (%d): invalid", "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t6666", len("TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t6666"), TronContractAddressLen),
		},
		{
			testName:   "lowercase address",
			value:      "tr7nhqjekqxgtci8q8zy4pl8otszgjlj6t",
			expectPass: false,
			err:        fmt.Errorf("address: %s: invalid", "tr7nhqjekqxgtci8q8zy4pl8otszgjlj6t"),
		},
		{
