...
func (k Keeper) convertCoinNativeCoin(
	...
	// Mint Tokens and send to receiver
	_, err := k.CallEVMWithModule(ctx, erc20, contract, "mint", receiver, msg.Coin.Amount.BigInt())
	if err != nil {
		return nil, err
	}
...
func (k Keeper) convertCoinNativeERC20(
	...
	res, err := k.CallEVMWithModule(ctx, erc20, contract, "transfer", receiver, msg.Coin.Amount.BigInt())
	if err != nil {
		return nil, err
	}
