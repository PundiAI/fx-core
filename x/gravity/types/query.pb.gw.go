...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fx", "gravity", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_CurrentValset_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "valset", "current"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ValsetRequest_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "valset", "request"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ValsetConfirm_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "valset", "confirm"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ValsetConfirmsByNonce_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "valset", "confirms"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LastValsetRequests_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "valset", "requests"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LastPendingValsetRequestByAddr_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "valset", "last"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LastPendingBatchRequestByAddr_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "batch", "last"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LastEventNonceByAddr_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"fx", "gravity", "v1", "oracle", "event_nonce", "address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LastEventBlockHeightByAddr_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"fx", "gravity", "v1", "oracle", "event", "block_height", "address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BatchFees_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fx", "gravity", "v1", "batch_fees"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LastObservedBlockHeight_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "observed", "block_height"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OutgoingTxBatches_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "batch", "outgoing_tx"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BatchRequestByNonce_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "batch", "request"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BatchConfirm_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "batch", "confirm"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BatchConfirms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"fx", "gravity", "v1", "batch", "confirms"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ERC20ToDenom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fx", "gravity", "v1", "denom"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_DenomToERC20_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fx", "gravity", "v1", "erc20"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetDelegateKeyByValidator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fx", "gravity", "v1", "delegate_key_by_validator"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetDelegateKeyByEth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fx", "gravity", "v1", "delegate_key_by_eth"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetDelegateKeyByOrchestrator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fx", "gravity", "v1", "delegate_key_by_orchestrator"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetPendingSendToEth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fx", "gravity", "v1", "pending_send_to_eth"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ProjectedBatchTimeoutHeight_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fx", "gravity", "v1", "projected_batch_timeout"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BridgeTokens_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"fx", "gravity", "v1", "bridge_tokens"}, "", runtime.AssumeColonVerbOpt(false)))
)
