...
var (
	...
	// LastTxPoolIDKey indexes the lastTxPoolID
	LastTxPoolIDKey = append(SequenceKeyPrefix, []byte("lastTxPoolId")...)

	// LastOutgoingBatchIDKey indexes the lastBatchID
	LastOutgoingBatchIDKey = append(SequenceKeyPrefix, []byte("lastBatchId")...)
