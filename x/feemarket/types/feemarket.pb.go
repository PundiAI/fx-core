...
type Params struct {
	...
	MinBaseFee github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,6,opt,name=min_base_fee,json=minBaseFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"min_base_fee"`
	// max base fee for EIP-1559 blocks.
	MaxBaseFee github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,7,opt,name=max_base_fee,json=maxBaseFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"max_base_fee"`
	// replace block max gas, if > 0
	MaxGas github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,8,opt,name=max_gas,json=maxGas,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"max_gas"`
}
...
var fileDescriptor_4feb8b20cf98e6e1 = []byte{
	...
	,
}
