...
func (suite *ParamsTestSuite) TestParamsValidate() {
	testCases := []struct {
		...
		{
			"valid",
			NewParams(true, 7, 3, 2000000000, int64(544435345345435345), MinBaseFee, MaxBaseFee, 50000000),
			false,
		},
		{
			"empty",
		...
		},
		{
			...
			NewParams(true, 0, 3, 2000000000, int64(544435345345435345), MinBaseFee, MaxBaseFee, 0),
			true,
		},
		{
			"if max base fee gt 0, max base fee(1) must be gte min base fee(100)",
			NewParams(true, 0, 3, 2000000000, int64(544435345345435345), sdk.NewInt(100), sdk.NewInt(1), 0),
			true,
		},
		{
			"valid",
			NewParams(true, 7, 3, 2000000000, int64(544435345345435345), MinBaseFee, sdk.ZeroInt(), 50000000),
			false,
		},
		{
			"valid",
			NewParams(true, 7, 3, 2000000000, int64(544435345345435345), sdk.NewInt(100), sdk.ZeroInt(), 50000000),
			false,
		},
	}
