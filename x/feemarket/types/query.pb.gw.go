...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"ethereum", "feemarket", "evm", "v1", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BaseFee_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"ethereum", "feemarket", "evm", "v1", "base_fee"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BlockGas_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"ethereum", "feemarket", "evm", "v1", "block_gas"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ModuleEnable_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"ethereum", "feemarket", "evm", "v1", "module_enable"}, "", runtime.AssumeColonVerbOpt(true)))
)
