...
func (mr *MockStakingKeeperMockRecorder) AfterDelegationModified(ctx, delAddr, valAddr interface{}) *gomock.Call {
...
func (mr *MockStakingKeeperMockRecorder) BeforeDelegationCreated(ctx, delAddr, valAddr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStakingMsgServerMockRecorder) BeginRedelegate(goCtx, msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStakingMsgServerMockRecorder) Delegate(goCtx, msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStakingMsgServerMockRecorder) Undelegate(goCtx, msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDistributionKeeperMockRecorder) GetDelegatorStartingInfo(ctx, val, del interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDistributionMsgServerMockRecorder) WithdrawDelegatorReward(goCtx, msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) ConvertCoin(goCtx, msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) ConvertDenomToTarget(ctx, from, coin, fxTarget interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) ConvertERC20(goCtx, msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) DeleteOutgoingTransferRelation(ctx, moduleName, txID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) GetTokenPair(ctx, tokenOrDenom interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) HasOutgoingTransferRelation(ctx, moduleName, txID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) HookOutgoingRefund(ctx, moduleName, txID, sender, totalCoin interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) IsOriginOrConvertedDenom(ctx, denom interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) SetOutgoingTransferRelation(ctx, moduleName, txID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) ToTargetDenom(ctx, denom, base, aliases, fxTarget interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) TransferAfter(ctx, sender, receive, coin, fee, arg5 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEVMKeeperMockRecorder) CallEVM(ctx, from, contract, value, gasLimit, data, commit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIBCTransferKeeperMockRecorder) SetDenomTrace(ctx, denomTrace interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIBCTransferKeeperMockRecorder) Transfer(goCtx, msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSubspaceMockRecorder) GetParamSet(ctx, ps interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSubspaceMockRecorder) WithKeyTable(table interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
